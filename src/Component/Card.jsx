...
export default function Card(props) {
  ...
  return (
    <>
      <div className="bg-gray-50 w-72 h-80 m-10  grid grid-rows-2 rounded-3xl">
        ...
        <div className=" grid  grid-rows-4  ">
          ...
          <div className=" grid grid-cols-2 font-mono">
            ...
            <p className="ml-3">Qualety : {props.qualety}</p>
            
              <button
                className="bg-blue-200 p-2 px-3 rounded-full ml-8  w-56 text-slate-800  mt-2"
                onClick={handleAdd}
              >
                Order
              </button>
